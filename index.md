...
### [Analyse d'Attrition - IBM](https://github.com/Elo3534/Attrition-IBM_Tableau_Python_Word)
*Tableau, Python, Analyse prédictive*
- Analyse des facteurs d'attrition des employés
- Dashboard interactif et modélisation

### [Analyse Netflix - Power BI](https://github.com/Elo3534/NETFLIX_PowerBI_DAX_OnlyOffice)
*Power BI, DAX, Visualisation*
- Analyse complète du catalogue Netflix
- Rapports dynamiques avec mesures DAX avancées
